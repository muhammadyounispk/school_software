...
class Teacher_model extends CI_Model {
    ...
    public function getTeacher($id = null) {
        ...
        $this->db->where('users.school_id', getSchoolID());
        $query = $this->db->get();
        if ($id != null) {
            return $query->row_array();
        } else {
    ...
    public function getTeacherByEmail($email = null) {
        ...
        $this->db->where('teachers.school_id', getSchoolID());
        $query = $this->db->get();
        if ($email != null) {
            return $query->row();
        } else {
    ...
    public function getTotalTeacher() {
        $sql = "SELECT count(*) as `total_teacher` FROM `teachers` where school_id=".getSchoolID()."";
