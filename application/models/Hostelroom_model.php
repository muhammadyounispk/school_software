...
class Hostelroom_model extends MY_Model
{
    ...
    public function getRoomByHoselID($hostel_id)
    {
        ...
        $this->db->where('hostel_rooms.school_id', getSchoolID());
        $query = $this->db->get();
        return $query->result();
    }
