...
class Itemstock_model extends MY_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->where('item_stock.school_id', getSchoolID());
        $query = $this->db->get();
        if ($id != null) {
    ...
    public function get_ItemByBetweenDate($start_date, $end_date) {
        $condition = " and date_format(item_stock.date,'%Y-%m-%d') between '" . $start_date . "' and '" . $end_date . "' and item_stock.school_id=".getSchoolID();
