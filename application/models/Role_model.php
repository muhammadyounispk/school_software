...
///======================
    ...
    public function getInsertBatch($role_id, $to_be_insert = array(), $to_be_update = array(), $to_be_delete = array()) {
        ...
        foreach ($to_be_insert as $s => $to_be_inserts) {
            $to_be_insert[$s]['school_id']=getSchoolID();
        }
        ...
        if (!empty($to_be_update)) {
            ...
            foreach ($to_be_update as $m => $to_be_inserts) {
                $to_be_update[$m]['school_id']=getSchoolID();
            }
