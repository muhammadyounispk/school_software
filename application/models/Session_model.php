...
class Session_model extends MY_Model {
    ...
    public function getAllSession() {
        $sql = "SELECT sessions.*, IFNULL(sch_settings.session_id, 0) as `active` FROM `sessions` LEFT JOIN sch_settings ON sessions.id=sch_settings.session_id where sessions.school_id='".getSchoolID()."' GROUP BY sessions.id" ;
