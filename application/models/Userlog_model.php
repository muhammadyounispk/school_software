...
class Userlog_model extends CI_Model {
    ...
    public function getAllRecord() {
        $this->datatables
                ...
                ->sort('login_datetime', 'desc')->where("userlog.school_id",getSchoolID())
                ->from($this->table);
    ...
    public function getAllRecordByRole($role) {
        $this->datatables
                ...
                ->orderable('user, role, ipaddress,login_datetime,user_agent')
                ->where('role', $role)
                ->sort('login_datetime', 'desc')->where("school_id",getSchoolID())
                ->from($this->table);
        return $this->datatables->generate('json');
    }
    ...
    public function getAllRecordByStaff() {
        $this->datatables
                ...
                ->orderable('user, role, ipaddress,login_datetime,user_agent')
                ->where('role!=', 'Parent')
                ->where('role!=', 'Student')->where("school_id",getSchoolID())
