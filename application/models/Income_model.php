...
class Income_model extends My_Model
{
    ...
    public function search($text = null, $start_date = null, $end_date = null)
    {
        if (!empty($text)) {
            ...
            $this->db->where('income.school_id', getSchoolID());
    ...
    public function getIncomeHeadsData($start_date, $end_date)
    {
        ...
        $condition = "date_format(date,'%Y-%m-%d') between '" . $start_date . "' and '" . $end_date . "' and income_head.school_id='".getSchoolID()."'";
    ...
    {
        $query = 'SELECT sum(amount) as `amount` FROM `income` where   school_id='.getSchoolID().' and  date=' . $this->db->escape($date);
    ...
    {
        $query = 'SELECT sum(amount) as `amount` FROM `income` where school_id='.getSchoolID().' and  date between ' . $this->db->escape($date_from) . ' and ' . $this->db->escape($date_to);
