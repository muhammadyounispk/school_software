    ...
    public function add_result($insert_array) {
        ...
        if (!empty($insert_array)) {
            foreach ($insert_array as $student_key => $student_value) {
                $student_value['school_id']=getSchoolID();
