...
class Studentsession_model extends CI_Model
{
    ...
    public function getTotalStudentBySession()
    {
        ...
        $query = "SELECT count(*) as `total_student` FROM `student_session` INNER JOIN students on students.id=student_session.student_id where student_session.session_id=" . $this->db->escape($this->current_session) . " and students.school_id=".$this->session->school_id." and students.is_active = 'yes' ";
    ...
    {   
        $insert_array['school_id']=getSchoolID();
        $not_delarray = array();
        $this->db->trans_start();
    ...
    public function searchMultiStudentByClassSection($class_id = null, $section_id = null,$is_active='yes')
    {

        $students = $this->student_model->searchByClassSectionWithSession($class_id, $section_id,$is_active);
    ...
    public function searchMultiStudentByFather($cnic)
    {

        $students = $this->student_model->searchByClassSectionbyCNIC($cnic);
