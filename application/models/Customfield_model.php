...
class customfield_model extends MY_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->where('custom_fields.school_id', $this->session->school_id);
        if ($id != null) {
        ...
        $this->db->where('custom_fields.school_id', getSchoolID());
        $query = $this->db->get();
        if ($id != null) {
            return $query->row();
        } else {
    ...
    public function insertRecord($custom_value_array, $insert_id) {
        ...
        foreach ($custom_value_array as $insert_key => $insert_value) {
            ...
            $custom_value_array[$insert_key]['school_id'] = getSchoolID();
        }
