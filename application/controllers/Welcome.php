...
class Welcome extends Front_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->free_website = $this->setting_model->ModuleRestriction(113);
        $q = "UPDATE front_cms_settings set is_active_front_cms ='" . $this->free_website . "' where  school_id = " . $this->session->school_id;
        $this->db->query($q);
        if (!$this->free_website) {
            header("location:site/userlogin");
        }
    }
