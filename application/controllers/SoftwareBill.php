...
class SoftwareBill extends CI_Controller
{
...
$path=create_pdf($html,$id.".pdf",false,['format'=>'A4']);
    ...
    {
        $id="0380002".getSchoolID();
echo $html=$this->getGuide($id,true);
    ...
    function getGuide($account_no=null,$html=false){
        ...
        <table style="border-bottom: solid; " width="100%" align="center">
            <tr>
                <td width="10%">   </td>
                <td><center><h2>Your School A/C ID: '.$account_no.'<br>Software Subcription will  Require Renewal  after  '.getSchoolInfo('valid_till').' </h2></hr><span style="font-size: 25px">PUITC Online Payment Guideline</span><br>Please Enter A/C: '.$account_no.' and validate your School Name " '.getSchoolInfo('name').' " and proceed your Billing , Your Software will be activated soon as Possible as Confirmed </center>
        ...
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/-v8_FixCwQs?si=LuCouHKf3eAlt539" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  ...
                  <div class="panel-group" id="accordion">
                      ...
                      <div class="panel panel-default">
                          ...
                          <div id="collapseHMB" style="font-size:10px">
                              ...
                              3. Select Educational Billing as Utility Type and then Select Kuick Pay as Utility Name<br />
                              ...
                              4. Select Educational Billing<br />
                              ...
                              2. Select Bill Payment<br /> 
                              3. Select Educational Billing/Others and then Select Kuickpay<br />
                              4. Enter <U> '.$account_no.' </u> <br />
                              5. Confirm details and Pay<br />
                              </div>
                          </div>
        ...
        function getBilling()  {
            ...
            $this->load->view('accounts/SoftwareBill', get_defined_vars());
