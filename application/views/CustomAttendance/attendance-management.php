                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('CustomAttendance') ?>" method="post" class="" id="search_fee_form">
                                        <?php
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <button style="margin-top: 5px;" type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm  checkbox-toggle"><i class="fa fa-check"></i> Proceed to Attendance</button>
                                        ...
                                        <div class="col-md-4">
                                        <a  class="fancybox brn btn-primary btn-sm  pull-right"   href="<?=base_url('CustomAttendance/markAttendanceByID');?>"><i class="fa fa-arrow-right"></i>  Mark Attendance by Student ID</a><br>
                                        <a style="margin-top: 5px;"  class=" brn btn-primary btn-sm  pull-right"  target="_blank"  href="https://drive.google.com/file/d/1hqGf7rXtGz6i7R1KmKN-O9we2-fqctUi/view?usp=drive_link"><i class="fa fa-android"></i> Download QR Attendance  App</a>
...
$(document).ready(function() {
        $('#search_fee_form').submit(function(e) {
            ...
            var formData = new FormData(this); // Create FormData object
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url() . 'CustomAttendance/searchbyform'; ?>', // Get the form's action attribute
