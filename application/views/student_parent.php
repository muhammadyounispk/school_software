...
<head>
    ...
    <style type="text/css">
       body {
  background-image: url('https://img.freepik.com/free-photo/back-school-background-with-school-supplies-copy-space_23-2148958977.jpg');
                    ...
                    <div class="col-lg-4"></div>
                        <div class="col-lg-4">
                            <div class="loginbg loginradius login390">
                                ...
                                <img style="height: 160px;" class="card-img-top" src="<?=base_url();?>/uploads/digis/student_parent.png" alt="Card image cap">
                                </center><br>
                                    ...
                                    ?>
                                    <form action="<?php echo site_url('site/studentParent') ?>" method="post">
