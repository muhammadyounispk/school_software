        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-12 uploadsticky">
                ...
                <div class="box box-primary ">
                    <div class="box-body text-center">
                        ...
                        ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/admin_logo/<?php echo $result->stamp; ?>" class="img-thumbnail" alt="" width="204" height="60">
                        <?php
                        }
                        ?>
                        <br />
                        <br />
                        Size: 250x45 px <br>
                        <a href="#admin_logo" role="button" class="btn btn-primary btn-sm upload_admin_logo" data-toggle="tooltip" title="Please upload stampt with signature" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> Stamp with Signature</a>
                    </div>
                </div>
            ...
            <div class="col-lg-10 col-md-9 col-sm-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="">
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new')      
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control mob" id="phone" name="sch_phone" value="<?php echo $result->phone; ?>"><span class="text-danger"><?php echo form_error('phone'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <!-- <div class="col-md-12">
                                        ...
                                        <div class="relative">   
                                            ...
                                            <h4 class="session-head"><?php echo $this->lang->line('mobile_app'); ?> <?php if ($app_ver) {
