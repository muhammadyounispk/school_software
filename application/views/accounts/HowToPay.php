...
$pdf='
        ...
        <table style="border-bottom: solid; " width="100%" align="center">
            <tr>
                <td width="10%">   </td>
                <td><center><span style="font-size: 25px">PUITC Online Payment Guideline</span><br>Please Enter A/C: '.$account_no.' and validate your School Name " '.getSchoolInfo('name').' " and proceed your Billing , Your Software will be activated soon as Possible as Confirmed </center>
