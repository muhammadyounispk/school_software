            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab" onclick="WhatsappShow()">
                                <?php echo $this->lang->line('scan_qr'); ?>
                            </a></li>
                        <li><a href="#tab_2" onclick="SMSShow()" data-toggle="tab">
                                <?php echo $this->lang->line('scan_qr_sms'); ?>
                            </a></li>
                    ...
                    <div class="row" id="sms_system"> 
                        <div class="col-md-12 minheight170">
                                        ...
                                        <table class="table" width="100%">
                                            ...
                                            <tbody>
                                                <?php if ($sms_devices) {
                                                    ...
                                                    foreach ($sms_devices as $key => $device) {
                                                        @$r++;
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $device['name']; ?></td>
                                                            <td>
                                                                <select id="default_sim" >
                                                                <option value="">-- Select --</option>
                                                                <?=displayDropDownArray($device['sims'],getSchoolInfo('default_sim'));?>
                                                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div id="smsQRCode"> </div>

                            </div>
                            <div class="col-md-5 text  disblock">
                                <table  width="100%">
                                    <tr>
                                        <th>Step 1</th>
                                        <td> Please Download App from Following Link 
                                        <a download="" href="https://sms.isdigitalschools.com/puitc_sms_system.apk" >https://sms.isdigitalschools.com/puitc_sms_system.apk</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Step 2</th>
                                        <td>After Installation Please Scan This QR Code
