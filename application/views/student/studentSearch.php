                    ...
                    <div class="nav-tabs-custom border0 navnoshadow">
                      <div class="box-header ptbnull"></div>  
                        <ul class="nav nav-tabs">
                            ...
                            <li class="">                                <a href="<?=base_url('FeeManagement/studentCard?auth_request='.str_encode(json_encode($_REQUEST)));?>'" style="margin-bottom: 10px;"  class="btn btn-primary btn-sm  fancybox"><i class="fa fa-user"></i>  Student Cards</a></li>
                        </ul>
  ...
  $display_field= "<a href=".$student[$fields_value->name]." target='_blank'>".$student[$fields_value->name]."</a>";
                                                    ...
                                                    <?php
                                                            if (isAdmissionFom()) {
                                                                ...
                                                                <a href="<?php echo base_url(); ?>student/admissionform/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
...
<a href="#" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('no_admission_form'); ?>" >
                                                                <i class="fa fa-download"></i>  
                                                            </a>
