<div class="content-wrapper" style="min-height: 946px;">   
    <section class="content-header">
        <h1>
            ...
            <a href="<?=base_url('FeeManagement/studentCard?auth_request='.str_encode(json_encode($_REQUEST)));?>'" style="margin-bottom: 10px;"  class="btn btn-primary btn-sm  fancybox"><i class="fa fa-user"></i>  Student Cards</a>
