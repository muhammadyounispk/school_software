                ...
                <div class="box box-primary">
                    <div class="pull-right box-tools impbtntitle">
                        <?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) { ?>
                            ...
                            <a href="<?php echo site_url('student/UploadAdmissionForm') ?>">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_admission_form'); ?></button>
                            </a>
                        <?php }
                        ?>
                    </div>
                            ...
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" style="position: absolute;margin-top: 22px;" class="btn btn-sm mysiblings anchorbtn "><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('sibling'); ?></button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('cnic_bform'); ?> <span class="req">*</span></label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('father_name'); ?><small class="req"> *</small></label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('father_cnic'); ?><span class="req">*</span></label>
                                                <input id="father_cnic" name="father_cnic" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_cnic'); ?>" />
                                            ...
                                            <div class="row ">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="cast" id="cast"  placeholder="" type="text" class="form-control  "  value="<?php echo set_value('cast'); ?>" />
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="mobileno" id="mobilenovalid"  placeholder="" type="text" class="form-control  mob"  value="<?php echo set_value('mobileno'); ?>" />
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="father_phone" name="father_phone" placeholder="" type="text" class="form-control  mob"   value="<?php echo set_value('father_phone'); ?>" />
...
<?php } if ($sch_setting->guardian_relation) { ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_relation" name="guardian_relation" placeholder="" value="Father" type="text" class="form-control"  value="<?php echo set_value('guardian_relation'); ?>" />
...
<?php } ?>
                            ...
                            <div class="box-footer">
                                ...
                                <?php if(isAdmissionFom()){?>
                                    ...
                                    <input name="actions[]" type="checkbox" checked value="download_admission_form"> <?php echo $this->lang->line('print_admission_form'); ?>
                                    <input name="actions[]" type="checkbox" checked value="sms"> <?php echo $this->lang->line('sms'); ?>
                                    <input name="actions[]" type="checkbox" checked value="whatsapp"> <?php echo $this->lang->line('whatsapp'); ?>
                                    <input name="actions[]" type="checkbox" checked value="email"> <?php echo $this->lang->line('email'); ?>
                                    </div>
...
<script type="text/javascript">
    ...
    $("#father_name").on("keyup change", function (e){
        $("#guardian_name").val($(this).val());
    });
       $("#father_phone").on("keyup change", function (e){
        $("#guardian_phone").val($(this).val());
    });

     $("#guardian_email").on("keyup change", function (e){
        $("#guardian_email").val($(this).val());
    });
        $("#father_occupation").on("keyup change", function (e){
        $("#guardian_occupation").val($(this).val());
    });
    //     $("#mobilenovalid").on("keyup change", function (e){
    //     $("#father_phone").val($(this).val());
    //     $("#guardian_phone").val($(this).val());
    // });
