            ...
            <div class="col-md-3"> 
                ...
                ?>>
                    <div class="box-body box-profile">
                        ...
                        <br>
                        <a style="margin: 25px;" href="<?php echo base_url() . "student/admissionform/" . $student["id"] ?>" class="pull-right btn btn-primary"><?php echo $this->lang->line('download_admission_form'); ?></a>
                    </div>
                </div>
                <?php
                if (!empty($siblings)) {
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="3"><img class="profile-user-img img-responsive img-circle" src="<?php
                                                if (!empty($student["father_pic"])) {
                                                    echo base_url() .  "uploads/student_images/".$student["father_pic"];
                                                } else {
                                            ...
                                            <td rowspan="3">
                                              <?php  if ($sch_setting->guardian_pic) { ?><img class="profile-user-img img-responsive img-circle" src="<?php
                                                if (!empty($student["guardian_pic"])) {
                                                    echo base_url() .  "uploads/student_images/". $student["guardian_pic"];
                                                } else {
                                                    echo base_url() . "uploads/student_images/no_image.png";
                                                }
                                                ?>" > <?php } ?></td>
...
<?php if ($this->session->flashdata('take_print')) { ?>
            <script>
                window.location='../admissionform/<?php echo $student['id'];?>';
