                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="whatsapp" name="group_send_by[]"><?php echo $this->lang->line('whatsapp'); ?>
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="whatsapp" name="individual_send_by[]"><?php echo $this->lang->line('whatsapp'); ?>
                                                </label>
                                                <label class="checkbox-inline">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="whatsapp" name="class_send_by[]"><?php echo $this->lang->line('whatsapp'); ?>
                                                </label>
                                                <label class="checkbox-inline">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="whatsapp" name="birthday_send_by[]"><?php echo $this->lang->line('whatsapp'); ?>
                                                </label>
                                                <label class="checkbox-inline">
