                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                            <input id="auto_voucher_none" <?php echo set_radio('auto_voucher', '0', (set_value('0', $feegroup_type->auto_voucher) == "0") ? TRUE : FALSE); ?>  name="auto_voucher" checked placeholder="" type="radio"  value="0" />
                                            <span for="auto_voucher_none" class="text-danger"><?php echo $this->lang->line('none') ?></span>
                                            </div>

                                            <div class="col-sm-4">
                                            <input id="auto_voucher_monthly" <?php echo set_radio('auto_voucher', '1', (set_value('1', $feegroup_type->auto_voucher) == "1") ? TRUE : FALSE); ?> name="auto_voucher" placeholder="" type="radio"  value="1" />
                                            <span for="auto_voucher_monthly" class="text-danger"><?php echo $this->lang->line('monthly') ?></span>
                                            </div> 

                                            <!-- <div class="col-sm-4">
                                            <input id="auto_voucher_yearly" <?php echo set_radio('auto_voucher', '2', (set_value('2', $feegroup_type->auto_voucher) == "2") ? TRUE : FALSE); ?> name="auto_voucher" placeholder="" type="radio"  value="2" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="pointer-events:none;background-color:pink"  id="fee_groups_id" name="fee_groups_id" class="form-control" >
                                                    ...
                                                    <td class="mailbox-name">
                                                        <ul class="liststyle1">
                                                            ...
                                                            foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                                ...
                                                                <li> 
                                                                <?=$feetype_value->auto_voucher > 0  ?  '<i data-toggle="tooltip" title="'.$this->lang->line($this->auto_voucher[$feetype_value->auto_voucher]).'" class="fa fa-repeat" ></i>' : null;?>
                                                                    <?php if($feetype_value->type!='Balance'){?>
