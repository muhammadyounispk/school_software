                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="cnic" name="cnic"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('cnic') ?>" />
...
<h4 class="pagetitleh2">Salary Management </h4>
<div class="around10">
 ...
 <tr>
    <td  width="50%">   
        <table align="center">
        <input name="back_url" hidden value="<?= current_url(); ?>">
        <?php
        $salary = json_decode($staff["meta"], true);
        $arr_salary = [];
        $arr_title = [];
        ...
        foreach ($salary as $key => $sal) {
            ...
            $arr_salary[$id] = $amount;
            $arr_title[$id] = $title;
        }

        foreach (getSalaryHeads() as $key => $salary) {

            $amount = $arr_salary[$salary['id']];
            $title = $arr_title[$salary['id']];

        ?>
            <tr>


                <td width="10%"><input name="salary[]" class="form-control" value="<?= $salary['id']; ?>"></td>
                <td width="70%"><input name="salary[title][<?= $salary['id']; ?>]" class="form-control" value="<?= $title ? $title : $salary['title']; ?>"></td>
                <td><input name="salary[amount][<?= $salary['id']; ?>]" class="form-control" value="<?= $amount > 0 ?  $amount : 0 ?>"></td>
            </tr>
    ...
    <td  width="50%">   
        ...
        foreach (getSalaryHeads('DR',false) as $key => $salary) {
