                ...
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/index') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <?php if(@$_REQUEST['class_id']){?>
<div class="row " style="margin-bottom: 12px;">
<div class="col-md-12 text-right">
<button class="btn btn-primary btn-sm" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" onclick="if(this.innerHTML=='Search Again'){this.innerHTML='Close';}else{this.innerHTML='Search Again';}">Search Again</button>
                        ...
                        <div class="">
                            ...
                            <div class="box-body">
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    if (!isset($msg)) {
                                        if ($resultlist[0]['attendence_type_id'] != "") {
                                            if ($resultlist[0]['attendence_type_id'] != 5) {
                                                ...
                                                ?>
                                                <span style="margin-left: 35%;margin-top: 12px;position: absolute;" class="alert alert-success"><?php echo $this->lang->line('attendance_already_submitted_you_can_edit_record'); ?></span>
                                                <?php
                                            } else {
                                                $checked = "checked='checked'";
                                                ?>
                                                <span style="margin-left: 35%;margin-top: 12px;position: absolute;" class="alert alert-warning"><?php echo $this->lang->line('attendance_already_submitted_as_holiday'); ?>. <?php echo $this->lang->line('you_can_edit_record'); ?></span>
                                                <?php
                                            }
                                        }
                                    } else {
                                    ...
                                    ?>
                                    <form action="<?php echo site_url('admin/stuattendence/SaveAttendance') ?>" method="post" class="form_attendence">
                                        <?php echo $this->customlib->getCSRF(); ?>
                                ...
                                <input type="checkbox" id="checkSMS" >SMS
                                    ...
                                    <button type="submit" name="search" value="saveattendence" class="btn btn-primary btn-sm "><i class="fa fa-save"></i> <?php echo $this->lang->line('save_attendance'); ?> </button>
                                            ...
                                            <table class="table table-hover table-striped example"> 
                                                <thead>
                                                    <tr >
                                                        ...
                                                        <th width="5%">#</th>
                                                        <th width="10%"><?php echo $this->lang->line('admission_no'); ?></th>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <th width="5%"><?php echo $this->lang->line('roll_no'); ?></th>
                                                        <th width="25%"><?php echo $this->lang->line('name'); ?></th>
                                                        <th width="15%"><?php echo $this->lang->line('phone'); ?></th>
                                                        <th width="10%"><?php echo $this->lang->line('attendance'); ?></th>
                                                        <th width="5%" title="Current Month Attendance Report">CMAT* Report</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($resultlist as $key => $value) {
                                                        ...
                                                        $dates=getMonthStartAndEndDates($current_date);
                                                        $start=$dates['start'];
                                                        $end=$dates['end'];
                                                        $attendance=db::getRecord("
                                                        SELECT

                                                        COUNT(CASE WHEN attendence_type_id = 1  THEN 1 END) AS `P`,
                                                        COUNT(CASE WHEN attendence_type_id = 4  THEN 1 END) AS `A`,
                                                        COUNT(CASE WHEN attendence_type_id = 2  THEN 1 END) AS `L`

                                                         from student_attendences where student_session_id={$value['student_session_id']}
                                                        and date between '$start' and '$end'
                                                        ");
                                                    

                                                        ?>
                                                        <tr <?php if($value['attendence_type_id']==4){?>style="background-color: #6a7a60; color:white"<?php }?>>
                                                        <td>
<input type="checkbox" clas="sendsms" name="notify[<?php echo $value['student_session_id']; ?>][]" value="sms"  class="send_sms">SMS<br>
<input type="checkbox" clas="whatsapp" name="notify[<?php echo $value['student_session_id']; ?>][]" value="whatsapp" class="send_whatsapp">WA<br>
<input type="checkbox" clas="email" name="notify[<?php echo $value['student_session_id']; ?>][]" value="email" class="send_email">EM<br>
</td>
                                                            <td>
            ...
            echo $this->customlib->getFullName($value['firstname'],$value['middlename'],$value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?>
                        ...
                        <?php echo $this->lang->line($att_type); ?> 
                                                            ...
                                                            <td>
                                                            <?php 
 foreach ($attendance as $type => $total) {
    echo '<span class="badge badge-info">' . $type . ': ' . $total . '</span>&nbsp;';
}
                                                            ?>
                                                            </td>
                                                            <?php if ($date == 'xxx') { ?> 
    ...
    $(document).ready(function () {
    $("form.form_attendence").submit(function (event) {
