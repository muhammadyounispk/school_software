            ...
            <div class="modal-content modal-media-content">
                <div class="modal-header modal-media-header">
                    ...
                    <h4 class="box-title"> <?php echo $this->lang->line('admission_enquiry'); ?></h4> 
                                 ...
                                 <div class="text-right"><b><?php echo $this->lang->line('notify_alert');?></b>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input data-inputmask="'mask': '+\\923999999999'" id="number" autocomplete="off" name="contact" placeholder="" type="text" class="form-control"  value="<?php echo set_value('contact'); ?>" />
