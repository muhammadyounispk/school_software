                ...
                <div class="box box-primary">
                    ...
                    if (isset($resultlist)) {
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title"><i class="fa fa-list"></i>To Promote Students to following Class and section </h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  id="session_id" name="session_id" class="form-control" >
                                                ...
                                                foreach ($sessionlist as $session) {
                                                    ?>
                                                    <option selected value="<?php echo $session['id'] ?>" ><?php echo $session['session'] ?></option>
                                                    <?php
                                                    $count++;
                                                }
                                                ?>
