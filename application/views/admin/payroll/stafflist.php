    ...
    <?php } ?>
                                ...
                                <tbody>    
                                    ...
                                    foreach ($resultlist as $staff) {
                                        $staff_id=$staff['id'];
                                        $paid_info=isSalayPaid(getStaffAccount($staff_id),$_POST['month'],$_POST['year']);
                                        $status = $staff["status"];
                                        ...
                                        <tr>
                                            ...
                                            <?php } if ($sch_setting->staff_phone) { ?>
                                                ...
                                                <td><?php echo nf($staff['salary']); ?></td>
                                                <?php } ?>
                                                <td><?php if($paid_info){
                                                    echo "Paid";
                                                }else{
                                                ...
                                                <a class="btn btn-primary btn-xs fancybox checkbox-toggle edit_setting" role="button" href="<?php echo base_url() . "admin/payroll/employeeServices/". $staff["id"] ?>">Services/Welfare</a>


                                                <?php if($paid_info){
                                                 ?>
                                                   <a class="btn btn-primary btn-xs fancybox checkbox-toggle edit_setting" role="button" href="<?php echo base_url() . "admin/payroll/payslipDownload/" . $month_selected . "/" . $year . "/" . $staff["id"] ?>?auth=<?=str_encode($paid_info['id']);?>">Pay slip</a>

                                                 <?php 
                                                }else{
                                                    ?>

<a class="btn btn-primary btn-xs fancybox checkbox-toggle edit_setting" role="button" href="<?php echo base_url() . "admin/payroll/create/" . $month_selected . "/" . $year . "/" . $staff["id"] ?>">Transfer Salay </a>
                                                    <?php
                                                }
                                                    ?>
