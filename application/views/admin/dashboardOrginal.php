            ...
            <div class="col-lg-7 col-md-7 col-sm-12 col60">
                ...
                <div class="box box-info borderwhite" >
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('online_fee_payment'); ?> </h3>
                    ...
                    <div class="box-body" >
                        <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="info-box ">
                                           <img onclick="if(confirm('Are you sure to Contact Your Engineer via Whatsapp on behalf of <?php echo getSchoolInfo('name');?>?')){window.open('https://wa.me/923099914748?text=Helo, I need Help,From: <?php echo getSchoolInfo('name');?>','_BLANK');}"  style="width: -webkit-fill-available;height: 113px;" src="<?=DIGIS_HTTP;?>/help.png">
                                        </div>
                                    </div>
                ...
                if ($this->rbac->hasPrivilege('income_donut_graph', 'can_view')) {
                    ...
                    ?></h3></div>
                            ...
                            <div class="box-body">
                                ...
                                <?php if(!$incomegraph){
                                   ?>
                                    <img onclick="window.location='../income'"   src="<?=DIGIS_HTTP;?>/no_income.gif" style="width: -webkit-fill-available;">
...
?>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col60">
                                ...
                                <div class="box box-primary borderwhite">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="chart">
                            <?php if(!$incomegraph){?>
                                <img onclick="window.location='../feemaster'"  src="<?=DIGIS_HTTP;?>/no_fee.png" style="width: -webkit-fill-available;">
                            <?php }else{?>
    ...
    <?php if ($this->rbac->hasPrivilege('expense_donut_graph', 'can_view')) { ?>
        ...
        ?></h3>
                            ...
                            <div class="box-body">
                               <?php if(!$incomegraph){?>
                              <img  onclick="window.location='../expense'"   src="<?=DIGIS_HTTP;?>/no_expense.gif" style="width: -webkit-fill-available;">
                              <?php }else{?>
                                <div class="chart-responsive">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            ...
                            <div class="progress-group">
                             ...
                             <p class="text-uppercase mt10 clearfix" style="margin-bottom: 33px"></span>
                            </p>
...
if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_view')) {
    $div_rol = 3;
    ?>
                        <div class="box box-primary borderwhite" style="height: 543px; overflow: hidden;">
                            <div class="box-body">
                                <!-- THE CALENDAR -->
                                <div id="calendar"></div>
                            </div>
