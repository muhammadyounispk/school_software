<div class="container">
    ...
    <dive class="row">
        ...
        <div class="col-md-8 ">
                ...
                <span class="info-box-text">proceed with</span> 
                <br>
                <button onclick="window.location='<?=base_url('FeeManagement/exportPaidlist?auth_request='.str_encode(json_encode($_REQUEST)));?>'">Paid list</button>
                <button onclick="window.location='<?=base_url('FeeManagement/exportUnPaidlist?auth_request='.str_encode(json_encode($_REQUEST)));?>'">unpaid list</button>
                <button onclick="window.location='<?=base_url('FeeManagement/exportDefaulterList?auth_request='.str_encode(json_encode($_REQUEST)));?>'">Defaultrer list</button>
                <button onclick="window.location='<?=base_url('FeeManagement/exportDisabledist?auth_request='.str_encode(json_encode($_REQUEST)));?>'">Disabled Student Dues</button>
                <button onclick="window.location='<?=base_url('FeeManagement/exportVouchers?auth_request='.str_encode(json_encode($_REQUEST)));?>'">3T-Vouchers</button>
                <button onclick="window.location='<?=base_url('FeeManagement/export1TVouchers?auth_request='.str_encode(json_encode($_REQUEST)));?>'">1T-Vouchers</button>
                </div>
            </div>
        ...
        <div class="col-md-4 ">
                ...
                <div class="info-box-content" style="height: 80px;">
                <span class="info-box-text">proceed  with</span> 
                <br>
              <a href="<?= base_url(); ?>/FeeManagement/collectionStatement" class="fancybox "><button style="color: blue;">Fee Collection Statement</button> </a>
                    ...
                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr <?php if($transaction){ echo "class='paid'";}else{echo "class='unpaid'";}?>>
                                        <td><?= $sr; ?></td>
                                       ...
                                       <?php }else{ ?>
                                        <td><a href="<?= base_url(); ?>/FeeManagement/takeFee?id=<?= $student['id']; ?>&fee_month=<?= $_REQUEST['fee_month']; ?>" class="fancybox "><?= $student['firstname']; ?></a></td>
                                       <?php }?>
